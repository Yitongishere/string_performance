...
if __name__ == "__main__":
    ...
    files_path = f"../data/cello_1113/cello_1113_pgy/video/cello_1113_pgy_21334211.avi"

    # output path for extracted frames
    # output_path = f"../data/cello_1113/cello_1113_pgy/frames"
    output_path = f"../data/cello_1113/cello_1113_pgy/frames"

    extract_frames_interval(files_path, output_path, 125, 126)  # For camera calibration
