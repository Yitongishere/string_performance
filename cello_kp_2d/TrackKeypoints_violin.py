...
if __name__ == '__main__':
    ...
    video_path = r'../data/violin_test3_0102/videos/violin_test3_0102_21334181.avi'
    ...
    # violin_keypoints = ['scroll_top', 'nut_l', 'nut_r', 'bridge_l', 'bridge_r', 'tail_gut', 'end_pin']
    # bow_keypoints = ['frog', 'tip_plate']

    violin_keypoints = ['scroll_top', 'nut_l', 'nut_r']
    bow_keypoints = []
                ...
                if (num + 1) % iter_frames == 0 or num == video.count_frames() - 1:
                    ...
                    if ((num + 1) // iter_frames + int((num + 1) % iter_frames > 0)) == 1:
                        ...
                        for item in labelled_info['shapes']:
                            if item['label'] in violin_keypoints + bow_keypoints:
                                kpdict[(violin_keypoints + bow_keypoints).index(item['label'])] = item['points'][0]
                                continue
    ...
    colormap = viz_utils.get_colors(len(violin_keypoints + bow_keypoints))
